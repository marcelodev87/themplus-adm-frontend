...
<template>
  <!-- <section>
    ...
    >
      ...
      <div v-if="!$q.screen.lt.sm" class="col-7 row items-center justify-end q-gutter-x-sm">
        <q-btn
          v-show="user?.enterprise_id === user?.view_enterprise_id && movementsAnalyze > 0"
    ...
    <q-scroll-area :class="!$q.screen.lt.sm ? 'main-scroll' : 'movement-scroll'">
      <main class="q-pa-sm q-mb-md" :style="!$q.screen.lt.sm ? '' : 'width: 98vw'">
        <q-card flat bordered class="q-my-sm">
          ...
          <q-separator inset />
          <q-card-section class="row justify-between" :class="getClassTotal(dataMovement.total)">
            <span>Saldo:</span>
        ...
        >
            ...
            <div :class="!$q.screen.lt.md ? '' : 'column full-width'">
              ...
              <div v-if="!$q.screen.lt.md" class="row">
                ...
                <q-select
                  ...
                  :readonly="listMonthYear.length === 0 || loadingMovement || loadingExport"
              ...
              >
                ...
                <q-input filled v-model="filterMovement" dense label="Pesquisar" class="q-mt-sm">
                  <template v-slot:prepend>
                    <q-icon name="search" />
                  </template>
                </q-input>
          ...
          <template v-slot:body="props">
            ...
            >
              ...
              >
                <q-icon v-if="props.row.receipt" name="picture_as_pdf" size="20px" />
              </q-td>
              <q-td key="action" :props="props">
                <q-btn
                  v-show="!delivered && user?.enterprise_id === user?.view_enterprise_id"
        ...
        <FormEntry
          ...
          :title="selectedDataEdit === null ? 'Registre uma entrada' : 'Atualize uma entrada'"
          mode="movement"
        ...
        <FormOut
          ...
          type="client"
          :data-edit="selectedDataEdit"
          :title="selectedDataEdit === null ? 'Registre uma saída' : 'Atualize uma saída'"
          mode="movement"
        ...
        />
        <FormInsertMovement :open="showFormInsertMovement" @update:open="closeFormInsertMovement" />
        <MovementsAnalyze :open="showMovementsAnalyze" @update:open="closeMovementsAnalyze" />
        <ConfirmAction
